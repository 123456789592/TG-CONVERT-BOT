...
my_father = "https://t.me/Mega_Bots_Updates".format(Config.USER_NAME[1:])
support = "https://telegram.dog/Mega_Bots_Supporters"
...
async def start(c, m):
    ...
    await c.send_message(chat_id=m.chat.id,
                         ...
                         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("My Father 👨‍💻", url=https://t.me/Mega_Bots_Updates), InlineKeyboardButton("📌Support channel", url=https://t.me/Mega_Bots_Supporters)]]))
